...
public partial class MerakiClient
{
	...
	private static readonly Dictionary<string, string> _serialNumberModels = new()
	{
		...
		{ "Q5UK", "C9200L-24T-4G" },
		{ "Q5UL", "C9200L-24P-4G" },
		{ "Q5VC", "C9200CX-8UXG-2X" },
		// Added 2026-06-19 from DataMagic prod logs (serials seen in Meraki inventory but previously unmapped)
		{ "Q2AY", "MS355-24X" },
		{ "Q2CY", "MS355-48X" },
		{ "Q2SY", "MG21E-NA" },
		{ "Q2UV", "MV63" },
		...
		{ "Q5VP", "C9300L-24P-4G" },
		{ "Q5VZ", "C9500-24Y4C" },
		// Added 2026-06-22 from DataMagic prod logs (serials seen in Meraki inventory but previously unmapped)
		{ "Q5ET", "CW9172I" },
		// Added 2026-06-27 from DataMagic prod logs (serials seen in Meraki inventory but previously unmapped)
		{ "Q4SA", "C8111-G2" },
		...
		{ "Q3NK", "MR78" },
		// Added 2026-08-25 from DataMagic prod logs (serials seen in Meraki inventory but previously unmapped)
		{ "Q4NC", "C8455-G2" },
		{ "Q5CA", "C9350-48HX" },
