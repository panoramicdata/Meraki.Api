...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class UpdateNetworkFloorPlan :  IEquatable<UpdateNetworkFloorPlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNetworkFloorPlan" /> class.
        /// </summary>
        /// <param name="Name">The name of your floor plan..</param>
        ...
        /// <param name="ImageContents">The file contents (a base 64 encoded string) of your new image. Supported formats are PNG, GIF, and JPG. Note that all images are saved as PNG files, regardless of the format they are uploaded in. If you upload a new image, and you do NOT specify any new geolocation fields (&#39;center, &#39;topLeftCorner&#39;, etc), the floor plan will be recentered with no rotation in order to maintain the aspect ratio of your new image..</param>
        public UpdateNetworkFloorPlan(string Name = default, Center1 Center = default, BottomLeftCorner BottomLeftCorner = default, BottomRightCorner BottomRightCorner = default, TopLeftCorner TopLeftCorner = default, TopRightCorner TopRightCorner = default, string ImageContents = default)
        {
            this.Name = Name;
            this.Center = Center;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateNetworkFloorPlan {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateNetworkFloorPlan);
        }

        /// <summary>
        /// Returns true if UpdateNetworkFloorPlan instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateNetworkFloorPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateNetworkFloorPlan other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
