...
namespace Meraki.Api.Data
{
    ...
    public partial class Scheduling :  IEquatable<Scheduling>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Enabled">Whether scheduling is enabled (true) or disabled (false). Defaults to false. If true, the schedule objects for each day of the week (monday - sunday) are parsed..</param>
        ...
        public Scheduling(bool? Enabled = default, Monday Monday = default, Tuesday Tuesday = default, Wednesday Wednesday = default, Thursday Thursday = default, Friday Friday = default, Saturday Saturday = default, Sunday Sunday = default)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Scheduling);
        }

        /// <summary>
        /// Returns true if Scheduling instances are equal
        /// </summary>
        /// <param name="other">Instance of Scheduling to be compared</param>
        /// <returns>Boolean</returns>
