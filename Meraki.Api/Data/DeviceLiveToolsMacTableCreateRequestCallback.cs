...
/// </summary>
[DataContract]
public class DeviceLiveToolsMacTableCreateRequestCallback
{
	/// <summary>
	...
	public DeviceLiveToolsMacTableCreateRequestCallbackHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public DeviceLiveToolsMacTableCreateRequestCallbackPayloadTemplate? PayloadTemplate { get; set; }
}