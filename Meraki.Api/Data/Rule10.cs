...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Rule10 :  IEquatable<Rule10>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rule10" /> class.
        /// </summary>
        [JsonConstructor]
        protected Rule10() { }
        /// <summary>
        ...
        /// <param name="DestCidr">Comma-separated list of destination IP address(es) (in IP or CIDR notation), fully-qualified domain names (FQDN) or &#39;any&#39; (required).</param>
        public Rule10(string Comment = default, Policy Policy = default, Protocol Protocol = default, string DestPort = default, string DestCidr = default)
        {
            // to ensure "Policy" is required (not null)
            if (Policy == null)
            {
                throw new InvalidDataException("Policy is a required property for Rule10 and cannot be null");
            }
            else
            {
                this.Policy = Policy;
            ...
            if (Protocol == null)
            {
                throw new InvalidDataException("Protocol is a required property for Rule10 and cannot be null");
            }
            else
            {
            ...
            if (DestCidr == null)
            {
                throw new InvalidDataException("DestCidr is a required property for Rule10 and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Rule10);
        }

        /// <summary>
        /// Returns true if Rule10 instances are equal
        /// </summary>
        /// <param name="other">Instance of Rule10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Rule10 other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
