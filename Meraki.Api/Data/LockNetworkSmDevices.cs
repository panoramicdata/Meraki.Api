...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class LockNetworkSmDevices :  IEquatable<LockNetworkSmDevices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LockNetworkSmDevices" /> class.
        /// </summary>
        /// <param name="WifiMacs">The wifiMacs of the devices to be locked..</param>
        /// <param name="Ids">The ids of the devices to be locked..</param>
        /// <param name="Serials">The serials of the devices to be locked..</param>
        /// <param name="Scope">The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be wiped..</param>
        /// <param name="Pin">The pin number for locking macOS devices (a six digit number). Required only for macOS devices..</param>
        public LockNetworkSmDevices(string WifiMacs = default, string Ids = default, string Serials = default, string Scope = default, int? Pin = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LockNetworkSmDevices {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as LockNetworkSmDevices);
        }

        /// <summary>
        /// Returns true if LockNetworkSmDevices instances are equal
        /// </summary>
        /// <param name="other">Instance of LockNetworkSmDevices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LockNetworkSmDevices other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
