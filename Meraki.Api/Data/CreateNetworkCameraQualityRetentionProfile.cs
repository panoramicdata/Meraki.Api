...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class CreateNetworkCameraQualityRetentionProfile :  IEquatable<CreateNetworkCameraQualityRetentionProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNetworkCameraQualityRetentionProfile" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreateNetworkCameraQualityRetentionProfile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNetworkCameraQualityRetentionProfile" /> class.
        /// </summary>
        /// <param name="Name">The name of the new profile. Must be unique. This parameter is required. (required).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateNetworkCameraQualityRetentionProfile {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as CreateNetworkCameraQualityRetentionProfile);
        }

        /// <summary>
        /// Returns true if CreateNetworkCameraQualityRetentionProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateNetworkCameraQualityRetentionProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateNetworkCameraQualityRetentionProfile other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
