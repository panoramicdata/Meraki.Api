...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Wan1 :  IEquatable<Wan1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Wan1" /> class.
        /// </summary>
        ...
        public Wan1(WanEnabled WanEnabled = default, bool? UsingStaticIp = default, string StaticIp = default, string StaticGatewayIp = default, string StaticSubnetMask = default, List<string> StaticDns = default, int? Vlan = default)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Wan1);
        }

        /// <summary>
        /// Returns true if Wan1 instances are equal
        /// </summary>
        /// <param name="other">Instance of Wan1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Wan1 other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
