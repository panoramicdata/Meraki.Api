...
/// </summary>
[DataContract]
public class LiveToolsAclHitCountCreateCallback
{
	/// <summary>
	...
	public LiveToolsAclHitCountCreateHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public LiveToolsAclHitCountCreatePayloadTemplate? PayloadTemplate { get; set; }
}