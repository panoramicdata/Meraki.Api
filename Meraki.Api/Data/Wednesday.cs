...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Wednesday :  IEquatable<Wednesday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Wednesday" /> class.
        /// </summary>
        ...
        public Wednesday(bool? Active = default, string From = default, string To = default)
        {
            this.Active = Active;
            this.From = From;
            this.To = To;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Wednesday);
        }

        /// <summary>
        /// Returns true if Wednesday instances are equal
        /// </summary>
        /// <param name="other">Instance of Wednesday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Wednesday other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
