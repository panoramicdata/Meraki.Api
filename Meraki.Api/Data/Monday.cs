...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Monday :  IEquatable<Monday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Monday" /> class.
        /// </summary>
        ...
        public Monday(bool? Active = default, string From = default, string To = default)
        {
            this.Active = Active;
            this.From = From;
            this.To = To;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Monday);
        }

        /// <summary>
        /// Returns true if Monday instances are equal
        /// </summary>
        /// <param name="other">Instance of Monday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Monday other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
