...
/// </summary>
[DataContract]
public class DeviceLiveToolsOspfNeighborCreateRequestCallback
{
	/// <summary>
	...
	public DeviceLiveToolsOspfNeighborCreateRequestCallbackHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public DeviceLiveToolsOspfNeighborCreateRequestCallbackPayloadTemplate? PayloadTemplate { get; set; }
}