...
/// </summary>
[DataContract]
public class DeviceLiveToolsDhcpLeaseCreateRequestCallback
{
	/// <summary>
	...
	public DeviceLiveToolsDhcpLeaseCreateRequestCallbackHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public DeviceLiveToolsDhcpLeaseCreateRequestCallbackPayloadTemplate? PayloadTemplate { get; set; }
}