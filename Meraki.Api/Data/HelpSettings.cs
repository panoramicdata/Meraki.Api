...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class HelpSettings :  IEquatable<HelpSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public HelpSettings(HelpTab HelpTab = default, GetHelpSubtab GetHelpSubtab = default, CommunitySubtab CommunitySubtab = default, CasesSubtab CasesSubtab = default, DataProtectionRequestsSubtab DataProtectionRequestsSubtab = default, string GetHelpSubtabKnowledgeBaseSearch = default, UniversalSearchKnowledgeBaseSearch UniversalSearchKnowledgeBaseSearch = default, string CiscoMerakiProductDocumentation = default, string SupportContactInfo = default, NewFeaturesSubtab NewFeaturesSubtab = default, FirewallInfoSubtab FirewallInfoSubtab = default, ApiDocsSubtab ApiDocsSubtab = default, HardwareReplacementsSubtab HardwareReplacementsSubtab = default, SmForums SmForums = default)
        {
