...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class CreateNetworkSwitchSettingsQosRule :  IEquatable<CreateNetworkSwitchSettingsQosRule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNetworkSwitchSettingsQosRule" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreateNetworkSwitchSettingsQosRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateNetworkSwitchSettingsQosRule" /> class.
        /// </summary>
        /// <param name="Vlan">The VLAN of the incoming packet. A null value will match any VLAN. (required).</param>
        ...
        /// <param name="Dscp">DSCP tag. Set this to -1 to trust incoming DSCP. Default value is 0.</param>
        public CreateNetworkSwitchSettingsQosRule(int? Vlan = default, Protocol8 Protocol = default, int? SrcPort = default, string SrcPortRange = default, int? DstPort = default, string DstPortRange = default, int? Dscp = default)
        {
            // to ensure "Vlan" is required (not null)
            if (Vlan == null)
            {
                throw new InvalidDataException("Vlan is a required property for CreateNetworkSwitchSettingsQosRule and cannot be null");
            }
            else
            {
                this.Vlan = Vlan;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateNetworkSwitchSettingsQosRule {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as CreateNetworkSwitchSettingsQosRule);
        }

        /// <summary>
        /// Returns true if CreateNetworkSwitchSettingsQosRule instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateNetworkSwitchSettingsQosRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateNetworkSwitchSettingsQosRule other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
