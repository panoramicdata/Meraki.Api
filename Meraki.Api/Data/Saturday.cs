...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Saturday :  IEquatable<Saturday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Saturday" /> class.
        /// </summary>
        ...
        public Saturday(bool? Active = default, string From = default, string To = default)
        {
            this.Active = Active;
            this.From = From;
            this.To = To;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Saturday);
        }

        /// <summary>
        /// Returns true if Saturday instances are equal
        /// </summary>
        /// <param name="other">Instance of Saturday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Saturday other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
