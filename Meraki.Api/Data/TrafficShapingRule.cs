...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class TrafficShapingRule :  IEquatable<TrafficShapingRule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrafficShapingRule" /> class.
        /// </summary>
        [JsonConstructor]
        protected TrafficShapingRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrafficShapingRule" /> class.
        /// </summary>
        ...
        public TrafficShapingRule(List<Definition> Definitions = default, PerClientBandwidthLimits PerClientBandwidthLimits = default, int? DscpTagValue = default, int? PcpTagValue = default, string Priority = default)
        {
            // to ensure "Definitions" is required (not null)
            if (Definitions == null)
            {
                throw new InvalidDataException("Definitions is a required property for TrafficShapingRule and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrafficShapingRule {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as TrafficShapingRule);
        }

        /// <summary>
        /// Returns true if TrafficShapingRule instances are equal
        /// </summary>
        /// <param name="other">Instance of TrafficShapingRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrafficShapingRule other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
