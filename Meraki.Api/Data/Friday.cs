...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Friday :  IEquatable<Friday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Friday" /> class.
        /// </summary>
        ...
        public Friday(bool? Active = default, string From = default, string To = default)
        {
            this.Active = Active;
            this.From = From;
            this.To = To;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Friday);
        }

        /// <summary>
        /// Returns true if Friday instances are equal
        /// </summary>
        /// <param name="other">Instance of Friday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Friday other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
