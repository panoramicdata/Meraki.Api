...
public class OrganizationDevicesPacketCaptureScheduleCreateRequest
{
	...
	public OrganizationDevicesPacketCaptureScheduleCreateRequestSchedule? Schedule { get; set; }

	/// <summary>
	/// Device details
	/// </summary>
	[DataMember(Name = "devices")]
	public List<OrganizationDevicesPacketCaptureScheduleCreateRequestDevice> Devices { get; set; } = [];
}
