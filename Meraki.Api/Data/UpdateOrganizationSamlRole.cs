...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class UpdateOrganizationSamlRole :  IEquatable<UpdateOrganizationSamlRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrganizationSamlRole" /> class.
        /// </summary>
        ...
        public UpdateOrganizationSamlRole(string Role = default, string OrgAccess = default, List<Tag2> Tags = default, List<Network2> Networks = default)
        {
            this.Role = Role;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateOrganizationSamlRole {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateOrganizationSamlRole);
        }

        /// <summary>
        /// Returns true if UpdateOrganizationSamlRole instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateOrganizationSamlRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateOrganizationSamlRole other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
