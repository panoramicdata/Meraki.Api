...
/// </summary>
[DataContract]
public class DeviceLiveToolsMulticastRoutingCreateRequestCallback
{
	/// <summary>
	...
	public DeviceLiveToolsMulticastRoutingCreateRequestCallbackHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public DeviceLiveToolsMulticastRoutingCreateRequestCallbackPayloadTemplate? PayloadTemplate { get; set; }
}