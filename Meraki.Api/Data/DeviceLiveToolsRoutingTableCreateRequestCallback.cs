...
/// </summary>
[DataContract]
public class DeviceLiveToolsRoutingTableCreateRequestCallback
{
	/// <summary>
	...
	public DeviceLiveToolsRoutingTableCreateRequestCallbackHttpServer? HttpServer { get; set; }

	/// <summary>
	/// The payload template of the webhook used for the callback
	/// </summary>
	[DataMember(Name = "payloadTemplate")]
	public DeviceLiveToolsRoutingTableCreateRequestCallbackPayloadTemplate? PayloadTemplate { get; set; }
}