...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class Sunday :  IEquatable<Sunday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Sunday" /> class.
        /// </summary>
        ...
        public Sunday(bool? Active = default, string From = default, string To = default)
        {
            this.Active = Active;
            this.From = From;
            this.To = To;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as Sunday);
        }

        /// <summary>
        /// Returns true if Sunday instances are equal
        /// </summary>
        /// <param name="other">Instance of Sunday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Sunday other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
