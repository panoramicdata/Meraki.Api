...
namespace Meraki.Api.Data
{
	...
	/// </summary>
	[DataContract]
    public partial class UpdateOrganizationAdmin :  IEquatable<UpdateOrganizationAdmin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrganizationAdmin" /> class.
        /// </summary>
        /// <param name="Name">The name of the dashboard administrator.</param>
        /// <param name="OrgAccess">OrgAccess.</param>
        ...
        public UpdateOrganizationAdmin(string Name = default, OrgAccess OrgAccess = default, List<Tag> Tags = default, List<Network> Networks = default)
        {
            this.Name = Name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateOrganizationAdmin {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as UpdateOrganizationAdmin);
        }

        /// <summary>
        /// Returns true if UpdateOrganizationAdmin instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateOrganizationAdmin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateOrganizationAdmin other)
        {
			// credit: http://stackoverflow.com/a/10454552/677735
			return other == null
					? false
