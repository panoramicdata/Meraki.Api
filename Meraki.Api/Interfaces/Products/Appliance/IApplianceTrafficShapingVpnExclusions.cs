...
public interface IApplianceTrafficShapingVpnExclusions
{
	...
	// The paged byNetwork declaration is commented out in git history: the endpoint does not return
	// an "items" envelope, so it cannot be paged until Meraki fixes it.
