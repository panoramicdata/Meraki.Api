...
public static class IWirelessRfProfilesExtensions
{
	...
	/// <param name="name">Optional parameter to filter RF profiles by device name. All returned devices will have a name that contains the search term or is an exact match.</paran>
